package top.lanscarlos.vulpecular.internal
...
object VulpecularScript {
    ...
    val workspace by lazy {
        ...
        Workspace(directory, namespace = listOf("vulpecular"))
    }

    fun eval(script: String, sender: Any?, namespace: List<String> = listOf("vulpecular"), args: Map<String, Any?>? = null, throws: Boolean = false): CompletableFuture<Any?> {
        val func = {
